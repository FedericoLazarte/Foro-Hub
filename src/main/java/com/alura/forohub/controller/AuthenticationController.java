...
import com.alura.forohub.domain.user.UserAuthenticationDTO;
import com.alura.forohub.infra.security.JWTDataToken;
...
public class AuthenticationController {
    ...
    public ResponseEntity authenticateUser(@RequestBody @Valid UserAuthenticationDTO userAuthenticationDTO) {
        Authentication authToken = new UsernamePasswordAuthenticationToken(userAuthenticationDTO.login(),
